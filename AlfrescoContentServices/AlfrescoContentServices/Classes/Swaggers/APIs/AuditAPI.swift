...
open class AuditAPI {
  ...
  "id" : "id"
    ...
    open class func getAuditAppWithRequestBuilder(auditApplicationId: String, fields: [String]? = nil, include: [String]? = nil) -> RequestBuilder<AuditApp> {
        ...
        let requestBuilder: RequestBuilder<AuditApp>.Type = AlfrescoContentServicesAPI.requestBuilderFactory.getBuilder()
  ...
  "entry" : {
    ...
    open class func getAuditEntryWithRequestBuilder(auditApplicationId: String, auditEntryId: String, fields: [String]? = nil) -> RequestBuilder<AuditEntryEntry> {
        ...
        let requestBuilder: RequestBuilder<AuditEntryEntry>.Type = AlfrescoContentServicesAPI.requestBuilderFactory.getBuilder()
  ...
  "list" : {
    ...
    open class func listAuditAppsWithRequestBuilder(skipCount: Int? = nil, maxItems: Int? = nil, fields: [String]? = nil) -> RequestBuilder<AuditAppPaging> {
        ...
        let requestBuilder: RequestBuilder<AuditAppPaging>.Type = AlfrescoContentServicesAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func listAuditEntriesForAuditApp(auditApplicationId: String, skipCount: Int? = nil, orderBy: [String]? = nil, maxItems: Int? = nil, _where: String? = nil, include: [String]? = nil, fields: [String]? = nil, completion: @escaping ((_ data: AuditEntryPaging?,_ error: Error?) -> Void)) {
        listAuditEntriesForAuditAppWithRequestBuilder(auditApplicationId: auditApplicationId, skipCount: skipCount, orderBy: orderBy, maxItems: maxItems, _where: _where, include: include, fields: fields).execute { (response, error) -> Void in
            completion(response?.body, error)
        }
    }
  ...
  "list" : {
     ...
     */
    open class func listAuditEntriesForAuditAppWithRequestBuilder(auditApplicationId: String, skipCount: Int? = nil, orderBy: [String]? = nil, maxItems: Int? = nil, _where: String? = nil, include: [String]? = nil, fields: [String]? = nil) -> RequestBuilder<AuditEntryPaging> {
        var path = "/alfresco/versions/1/audit-applications/{auditApplicationId}/audit-entries"
        let auditApplicationIdPreEscape = "\(auditApplicationId)"
        let auditApplicationIdPostEscape = auditApplicationIdPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        path = path.replacingOccurrences(of: "{auditApplicationId}", with: auditApplicationIdPostEscape, options: .literal, range: nil)
        ...
        let requestBuilder: RequestBuilder<AuditEntryPaging>.Type = AlfrescoContentServicesAPI.requestBuilderFactory.getBuilder()
