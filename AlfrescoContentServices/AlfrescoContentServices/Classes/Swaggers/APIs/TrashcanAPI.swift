...
open class TrashcanAPI {
  ...
  "entry" : {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getArchivedNodeRenditionContent(nodeId: String, renditionId: String, attachment: Bool? = nil, ifModifiedSince: Date? = nil, range: String? = nil, placeholder: Bool? = nil, completion: @escaping ((_ data: URL?,_ error: Error?) -> Void)) {
  ...
  "entry" : ""
    ...
    open class func getDeletedNodeWithRequestBuilder(nodeId: String, include: [String]? = nil) -> RequestBuilder<DeletedNodeEntry> {
        ...
        let requestBuilder: RequestBuilder<DeletedNodeEntry>.Type = AlfrescoContentServicesAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getDeletedNodeContent(nodeId: String, attachment: Bool? = nil, ifModifiedSince: Date? = nil, range: String? = nil, completion: @escaping ((_ data: URL?,_ error: Error?) -> Void)) {
  ...
  "list" : {
    ...
    open class func listDeletedNodesWithRequestBuilder(skipCount: Int? = nil, maxItems: Int? = nil, include: [String]? = nil) -> RequestBuilder<DeletedNodesPaging> {
        ...
        let requestBuilder: RequestBuilder<DeletedNodesPaging>.Type = AlfrescoContentServicesAPI.requestBuilderFactory.getBuilder()
