...
open class SearchAPI {
    /**
     ...
     - parameter queryBody: (body) Generic query API  
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func search(queryBody: SearchRequest, completion: @escaping ((_ data: ResultSetPaging?,_ error: Error?) -> Void)) {
        searchWithRequestBuilder(queryBody: queryBody).execute { (response, error) -> Void in
    ...
    "context" : {
      ...
      "request" : {
        ...
        "ranges" : [ {
          ...
          "hardend" : true,
          "field" : "field",
          "excludeFilters" : [ "excludeFilters", "excludeFilters" ],
          "gap" : "gap",
          "start" : "start",
          "end" : "end",
          "label" : "label"
        ...
        "defaults" : {
          "textAttributes" : [ "cm:content", "cm:content" ],
        ...
        "stats" : [ {
          "percentiles" : [ 1.2315135, 1.2315135 ],
          "cardinalityAccuracy" : 7.386282,
          "excludeFilters" : [ "excludeFilters", "excludeFilters" ],
          "max" : true,
          "sum" : true,
          "label" : "label",
     ...
     - returns: RequestBuilder<ResultSetPaging> 
     */
